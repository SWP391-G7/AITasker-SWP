/**
 * Frontend module: Components/Auth/AuthLayout.jsx
 *
 * Vai trò: Component Auth Layout: khối giao diện có thể tái sử dụng trong một hoặc nhiều page.
...
// React component “Auth Layout” nhận props, quản lý trạng thái cần thiết và render giao diện tương ứng.
