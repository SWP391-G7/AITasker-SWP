/**
 * Frontend module: Components/Dashboard/Admin/AdminModerationConfirmModal.jsx
 *
 * Vai trò: Component Admin Moderation Confirm Modal: khối giao diện có thể tái sử dụng trong một hoặc nhiều page.
...
// React component “Admin Moderation Confirm Modal” nhận props, quản lý trạng thái cần thiết và render giao diện tương ứng.
