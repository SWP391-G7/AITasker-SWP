/**
 * Frontend module: Components/Dashboard/Admin/DisputeDetailModal.jsx
 *
 * Vai trò: Component Dispute Detail Modal: khối giao diện có thể tái sử dụng trong một hoặc nhiều page.
