                    ...
                    {target === 'jobs' && (
                      <div className="row g-3">
                        <div className="col-12 col-sm-6 col-md-3">
                          ...
                          <input type="number" name="budgetMin" className="form-control filter-input" placeholder="Min budget" value={filters.budgetMin} onChange={handleFilterChange} />
                        </div>
                        <div className="col-12 col-sm-6 col-md-3">
                          <label className="filter-label">Max Budget ($)</label>
                          <input type="number" name="budgetMax" className="form-control filter-input" placeholder="Max budget" value={filters.budgetMax} onChange={handleFilterChange} />
                        </div>
                        <div className="col-12 col-sm-6 col-md-3">
                          <label className="filter-label">Required Skill</label>
                          <input type="text" name="requiredSkill" className="form-control filter-input" placeholder="e.g. Python, NLP" value={filters.requiredSkill} onChange={handleFilterChange} />
                        </div>
                        <div className="col-12 col-sm-6 col-md-3">
                          <label className="filter-label">Max Duration (Days)</label>
                          <input type="number" name="duration" className="form-control filter-input" placeholder="Duration in days" value={filters.duration} onChange={handleFilterChange} />
                        </div>
                      </div>
                    )}
                    ...
                    {target === 'services' && (
                      <div className="row g-3">
                        <div className="col-12 col-sm-6 col-md-4">
                          ...
                          <input type="number" name="priceMin" className="form-control filter-input" placeholder="Min price" value={filters.priceMin} onChange={handleFilterChange} />
                        </div>
                        <div className="col-12 col-sm-6 col-md-4">
                          <label className="filter-label">Max Price ($)</label>
                          <input type="number" name="priceMax" className="form-control filter-input" placeholder="Max price" value={filters.priceMax} onChange={handleFilterChange} />
                        </div>
                        <div className="col-12 col-sm-6 col-md-4">
                          <label className="filter-label">Pricing Type</label>
                          <select name="pricingType" className="form-select filter-input" value={filters.pricingType} onChange={handleFilterChange}>
                    ...
                    {target === 'expert' && (
                      <div className="row g-3">
                        <div className="col-12 col-sm-6 col-md-4">
                          ...
                          <input type="text" name="skill" className="form-control filter-input" placeholder="e.g. PyTorch, LLM" value={filters.skill} onChange={handleFilterChange} />
                        </div>
                        <div className="col-12 col-sm-6 col-md-4">
                          <label className="filter-label">Experience (Years/Level)</label>
                          <input type="text" name="experience" className="form-control filter-input" placeholder="e.g. 5 years, senior" value={filters.experience} onChange={handleFilterChange} />
                        </div>
                        <div className="col-12 col-sm-6 col-md-4">
                          <label className="filter-label">Professional Title</label>
                          <input type="text" name="professionalTitle" className="form-control filter-input" placeholder="e.g. AI Architect" value={filters.professionalTitle} onChange={handleFilterChange} />
                        </div>
                        <div className="col-12 col-sm-6 offset-md-2 col-md-4">
                          <label className="filter-label">Min Hourly Rate ($)</label>
                          <input type="number" name="hourlyRateMin" className="form-control filter-input" placeholder="Min $/hr" value={filters.hourlyRateMin} onChange={handleFilterChange} />
                        </div>
                        <div className="col-12 col-sm-6 col-md-4">
                          <label className="filter-label">Max Hourly Rate ($)</label>
                          <input type="number" name="hourlyRateMax" className="form-control filter-input" placeholder="Max $/hr" value={filters.hourlyRateMax} onChange={handleFilterChange} />
                        </div>
                      </div>
                    )}
                    ...
                    {target === 'client' && (
                      <div className="row g-3">
                        <div className="col-12 col-sm-6">
                          ...
                          <input type="text" name="industry" className="form-control filter-input" placeholder="e.g. FinTech, Healthcare" value={filters.industry} onChange={handleFilterChange} />
                        </div>
                        <div className="col-12 col-sm-6">
                          <label className="filter-label">Company Name</label>
                          <input type="text" name="companyName" className="form-control filter-input" placeholder="Search company" value={filters.companyName} onChange={handleFilterChange} />
                        </div>
                      </div>
                    )}
                  </div>
