...
const mapExpertFromApi = (expert) => {
  ...
  return {
    ...
    rating: Number(expert.avg_rating) || 5.0,
    reviews: Number(expert.review_count || expert.reviews_count) || 0,
    rate: hourlyRate,
...
const mapClientFromApi = (client) => {
  ...
  return {
    ...
    rating: Number(client.avg_rating) || 5.0,
    reviews: Number(client.review_count || client.reviews_count) || 0,
    rate: 0,
    tags: industry ? [String(industry).toUpperCase()] : [],
    description: client.bio || "No bio provided.",
    projects: Number(client.posted_jobs_count) || 0,
    available: false,
