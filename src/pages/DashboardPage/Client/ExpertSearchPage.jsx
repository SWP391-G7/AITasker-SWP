...
function ExpertSearchPage() {
  ...
  const [selectedStacks, setSelectedStacks] = useState(["Python"]);
  ...
  const filteredExperts = useMemo(() => {
    ...
    return result;
  }, [search, selectedStacks, rating, availability, sortBy]);
      ...
      <main className="expert-search-page">
        <section className="expert-main">
          <section className="expert-hero">
            ...
            <button className="advanced-filter-btn" type="button">
